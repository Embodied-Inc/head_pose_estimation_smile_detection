...
class SSR_net_MT:
    ...
    def __call__(self):
        ...
        img_input1 = Input(self._input_shape, batch_size=1)
        #-------------------------------------------------------------------------------------------------------------------------
        x = SeparableConv2D(16,(3,3),padding='same')(img_input1)
        ...
        #-------------------------------------------------------------------------------------------------------------------------
        s = SeparableConv2D(16,(3,3),padding='same')(img_input1)
        ...
        simple_dense_test = Dense(2, activation = 'softmax')(feat_s1_pre)
        ...
        model = Model(inputs=img_input1,  outputs=[pred_pose, simple_dense_test])
